...
console.log("テスト03が動作");
var test01 = {
  type: 'html-keyboard-response',
  stimulus:"<p style = 'color: red; font-size: 0.8em;'>スペースキーを押すと開始します</p>",
...
var instruction_pronounIAT_main01 = {
  type: 'html-keyboard-response',
  stimulus: '<p style="text-align: center;">お疲れさまでした。次の課題では<u>分類するカテゴリーが先ほどとは異なります</u>ので、下記の文章をよく確認してください。</p><br>'+
